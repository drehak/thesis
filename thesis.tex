...
The simplest way to use Pandoc is through the provided command line utility. When no arguments are provided, Pandoc takes text formatted with Markdown from the standard input and outputs the \textsc{html} equivalent on the standard output:
